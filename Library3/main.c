  ...
  if (mfile == NULL) {
   	...
   	while(fread(&book, sizeof(book), 1, file)) {
   		if(book.book_id == edit_book) {
   			found = 1;
				GoToXY(25, 12);
				printf("\xDB\xDB\xDB\xDB\xB2 Title: %s", book.title);
				GoToXY(25, 14);
				printf("\xDB\xDB\xDB\xDB\xB2 Author: %s", book.author);
				GoToXY(25, 16);
				printf("\xDB\xDB\xDB\xDB\xB2 Subject: %s", book.subject);
				GoToXY(25, 18);
				printf("\xDB\xDB\xDB\xDB\xB2 Taken by: %s", book.taken);
				GoToXY(25, 20);
				printf("\xDB\xDB\xDB\xDB\xB2 Deadline: %s", book.deadline);
				GoToXY(25, 22);
				printf("\xDB\xDB\xDB\xDB\xB2 Book ID: %d", book.book_id);
				...
				printf("\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2");
				GoToXY(25, 26);
				printf("\xDB\xDB\xDB\xDB\xB2        NEW RECORDS:         \xB2\xDB\xDB\xDB\xDB");
				GoToXY(25, 28);
				printf("\xDB\xDB\xDB\xDB\xB2 Title: ");
				fflush(stdin);
				fgets(book.title, 50, stdin);
				...
				GoToXY(25, 40);
				printf("\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2");
				fwrite(&book,sizeof(book), 1, mfile);
				fflush(stdin);
				GoToXY(25, 42);
				printf("Books has been updated......");
				i = 44;
			}
			else
					fwrite(&book,sizeof(book), 1, mfile);
	 ...
	 GoToXY(25, i);
	 printf("Do you want to edit other books?");
	 GoToXY(25, i+=1);
	 printf("1 - Yes.");
	 GoToXY(25, i+=1);
	 printf("2 - No.");
